...
public class Bar {
     ...
     */
    public Bar(GeneralMemoryStub m) {
        mem = m;
    }
     ...
     */
    public synchronized String lookAround() throws MyException {
        ((APS)Thread.currentThread()).setWaiterState("Appraising_Situation");
        mem.waiterLog("Appraising_Situation");
    ...
    public synchronized void shouldHaveArrivedEarlier() throws MyException{
        ((APS)Thread.currentThread()).setStudentState("PAYING_THE_MEAL");
        mem.studentLog("PAYING_THE_MEAL", ((APS)Thread.currentThread()).getStudentId());
    ...
    public synchronized void prepareTheBill() throws MyException {
        ((APS)Thread.currentThread()).setWaiterState("PROCESSING_THE_BILL");
        mem.waiterLog("PROCESSING_THE_BILL");
